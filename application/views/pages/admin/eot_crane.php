                            	...
                            	<table class="table table-bordered text-center" id="bootstrap-data-table-export">
                                    <thead>
                                        <tr>    
                                            ...
                                            <th>Application</th>                                        
                                            <th>Span</th>                                            
                                            <th>Above Floor MH</th>                                 
                                            <th>Below Floor MH</th>                                       
                                            <th>Travel Length</th>                                     
                                            <th>Column To Column</th>                                    
                                            <th>Speed MH</th>                                            
                                            <th>Speed AH</th>                                            
                                            <th>Speed CT</th>                                            
                                            <th>Speed IT</th>                                            
                                     ...
                                     if(!empty($list)){
                                        ...
                                        foreach ($list as $key => $value) {
                                          ...
                                          <tr>
                                           ...
                                           <td><?php echo $value['class_duty']?></td>
                                           <td><?php echo $value['design_standered']?></td>
                                           <td><?php echo $value['application']?></td>
                                           <td><?php echo $value['span']?></td>
                                           <td><?php echo $value['abv_floor_mh']?></td>
                                           <td><?php echo $value['blw_floor_ah']?></td>
                                           <td><?php echo $value['travel_length']?></td>
                                           <td><?php echo $value['column_to_column']?></td>
                                           <td><?php echo $value['speed_mh']?></td>
                                           <td><?php echo $value['speed_ah']?></td>
                                           <td><?php echo $value['speed_ct']?></td>
                                           <td><?php echo $value['speed_lt']?></td>
                                           <td><?php echo $value['vfd']?></td>
                                           <td><?php echo $value['scope_supply']?></td>
                                           <td><?php echo $value['installation']?></td>
                                           <td><?php echo $value['other_remarks']?></td>
                                           <td><button type="button" class="btn btn-sm btn-success inst" data-refno="<?php echo $value['refno'];?>" data-cust_id="<?php echo $value['cust_id'];?>" data-toggle="modal" data-target="#exampleModal">Send Details</button></td>
                                       </tr>
                                           <?php
                                        }  
                                     }
             ...
             <form method="POST" action="<?php echo base_url('admin/sendquotation')?>" enctype="multipart/form-data">  
                  <div class="modal-body">
                   <div class="row">
                       ...
                       <input type="hidden" name="quotation" value="EOT Crane">
