                                     ...
                                     if(!empty($list)){
                                        ...
                                        foreach ($list as $key => $value) {
                                          ...
                                          <tr>
                                           ...
                                           <td><?php echo $value['hoist_type']?></td> 
                                           <td><?php echo $value['arm']?></td>
                                           <td><?php echo $value['lifting_height']?></td>
                                           <td><?php echo $value['mh']?></td>
                                           <td><?php echo $value['ct']?></td>
                                           <td><?php echo $value['swivel']?></td>
                                           <td><?php echo $value['swivel_degree']?></td>
             ...
             <form method="POST" action="<?php echo base_url('admin/sendquotation')?>" enctype="multipart/form-data">  
                  <div class="modal-body">
                   <div class="row">
                       ...
                       <input type="hidden" name="quotation" value="JIB Crane">
